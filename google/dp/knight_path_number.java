...
/**
 * Created by junweixu on 17/1/8.
 */



    /*
    象棋马 8*8 给一个起始位置和一个step 每个move按 2+1的模式(一个方向走两格，换个方向再走一格。一起算一个move)走。
    走step个move 一个有几种走法。时空复杂度多少。有没有效率高点的算法。. From
     */

import java.util.LinkedList;
import java.util.Queue;

class knight_path_number {

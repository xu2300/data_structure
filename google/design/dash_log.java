 ...
 */
public class dash_log {

    public static final List<Integer> DASHEVC = new ArrayList<>(Arrays.asList(1798638,2762881,
            2756444,3712039,3584380,5513658,5483246,7453569,10600691,13541494,18366000,7229321,18078844));
    public static void main(String[] args) throws ParseException, IOException {
        String outPutDir = "/Users/junweixu/Desktop/3:13/5/";
    ...
    public static List<Double> getRepresentation(List<String> buffer){
        ...
        for(String s : buffer){
            ...
            int number = Integer.valueOf(s.substring(start+2,end));
            double rePresentation = (double)DASHEVC.get(number-1);
